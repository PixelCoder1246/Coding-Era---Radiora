...
export default function Hero({ user }: { user: User | null }) {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-main)', color: 'var(--foreground)' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            borderRadius: '50px', padding: '0.35rem 0.9rem', marginBottom: '1.5rem',
          ...
          <p style={{
            ...
            Radiora bridges your Orthanc PACS, HIS, and AI in one unified workstation — automatically creating cases, assigning doctors, and surfacing diagnostics the moment a scan arrives.
          </p>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
            {STATS.map(s => (
              <div key={s.label}>
                ...
                <div style={{ fontSize: '0.72rem', color: 'var(--secondary-foreground)', fontWeight: 600 }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              flex: 1, background: 'var(--background)', borderRadius: '6px',
              padding: '0.2rem 0.75rem', fontSize: '0.68rem',
              color: 'var(--muted-foreground)', fontFamily: 'monospace', textAlign: 'center',
              border: '1px solid var(--border)',
            }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <p style={{ fontSize: '0.75rem', fontWeight: 900, color: 'var(--primary)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '0.75rem' }}>
              Clinical Workflow
            </p>
            <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: 1.1 }}>
              From scan to report in{' '}
              <span style={{ background: 'linear-gradient(135deg, var(--primary), #818cf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                three steps
              </span>
            </h2>
          </div>
              ...
              return (
                <div key={step.number} style={{
                  ...
                  <div style={{
                    ...
                    fontSize: '4rem', fontWeight: 900, opacity: 0.04,
                    color: step.color, lineHeight: 1, pointerEvents: 'none',
                  }}>
                    {step.number}
                  </div>
                  ...
                  <div style={{ fontSize: '0.65rem', fontWeight: 900, color: step.color, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5rem' }}>
                    Step {step.number}
                  </div>
                  <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>
                    {step.title}
                  </h3>
                  <p style={{ fontSize: '0.9rem', color: 'var(--secondary-foreground)', lineHeight: 1.6, fontWeight: 500 }}>
                    {step.description}
                  </p>
      ...
      <section id="features" style={{ padding: '7rem 2rem', background: 'var(--background)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <p style={{ color: 'var(--secondary-foreground)', fontSize: '1.05rem', maxWidth: '550px', margin: '0 auto', lineHeight: 1.6 }}>
              A complete orchestration stack — not a point solution. Built to replace manual radiology coordination entirely.
            </p>
          </div>
            ...
            {FEATURES.map(f => {
              ...
              return (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '1.05rem', fontWeight: 800, marginBottom: '0.6rem', letterSpacing: '-0.01em' }}>
                    {f.title}
                  </h3>
                  <p style={{ fontSize: '0.875rem', color: 'var(--secondary-foreground)', lineHeight: 1.65, fontWeight: 500 }}>
                    {f.description}
                  </p>
                </div>
              );
      ...
      <section style={{ padding: '7rem 2rem', background: 'var(--muted)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            ...
            <div style={{
              background: 'var(--background)', border: '1px solid var(--border)',
              borderRadius: '24px', padding: '2.5rem', overflow: 'hidden', position: 'relative',
            }}>
              <div style={{
              ...
              <h3 style={{ fontSize: '1.35rem', fontWeight: 900, marginBottom: '0.5rem', letterSpacing: '-0.02em' }}>System Admin</h3>
              <p style={{ color: 'var(--secondary-foreground)', fontSize: '0.875rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Full orchestration control. Configure PACS and HIS connections, manage doctors, monitor all cases, and configure poll intervals.
              </p>
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', listStyle: 'none', padding: 0 }}>
                {['Register & manage doctors', 'PACS / HIS configuration', 'Real-time case monitor', 'DICOM study oversight'].map(item => (
                  <li key={item} style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', fontSize: '0.875rem', fontWeight: 600, color: 'var(--foreground)' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.35rem', fontWeight: 900, marginBottom: '0.5rem', letterSpacing: '-0.02em' }}>Diagnostic Doctor</h3>
              <p style={{ color: 'var(--secondary-foreground)', fontSize: '0.875rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                A focused clinical workstation. View assigned cases, open DICOM images, read AI findings, and submit structured reports — all in one place.
              </p>
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', listStyle: 'none', padding: 0 }}>
                {['Auto-assigned case queue', 'In-browser DICOM viewer', 'AI analysis results', 'Structured report submission'].map(item => (
                  <li key={item} style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', fontSize: '0.875rem', fontWeight: 600, color: 'var(--foreground)' }}>
      ...
      {/* ── CTA ───────────────────────────────────────────────────────── */}
      <section style={{
        padding: '7rem 2rem', background: 'var(--background)',
        textAlign: 'center',
      }}>
        <div style={{ maxWidth: '650px', margin: '0 auto' }}>
          <div style={{
            ...
            borderRadius: '50px', padding: '0.4rem 1rem', marginBottom: '2rem',
            fontSize: '0.75rem', fontWeight: 800, color: 'var(--primary)', textTransform: 'uppercase', letterSpacing: '0.08em',
          }}>
            <Zap size={13} />
            Ready to go
          </div>
          ...
          <p style={{ color: 'var(--secondary-foreground)', fontSize: '1.05rem', lineHeight: 1.65, marginBottom: '3rem' }}>
            Create an admin account, connect your PACS and HIS, and your first case will be auto-created the moment a scan arrives.
          </p>
